...
public class Ts {
	...
	public int getAdrArgCourante() {
		return adrArgCourante;
	}
	...
	public void affiche(PrintStream out) {
		ArrayList<Map.Entry<String, TsItemVar>> stVar = new ArrayList<Map.Entry<String, TsItemVar>>(
		...
		ArrayList<Map.Entry<String, TsItemFct>> stFct = new ArrayList<Map.Entry<String, TsItemFct>>(
				this.fonctions.entrySet());
