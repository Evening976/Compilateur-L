...
public class Sa2c3a extends SaDepthFirstVisitor<C3aOperand> {
	...
	public C3aOperand visit(SaIncr node) throws Exception {
		...
		c3a.ajouteInst(new C3aInstAdd(op1, op2, result, ""));
		c3a.ajouteInst(new C3aInstAffect(result, op1, ""));
	...
	public C3aOperand visit(SaExpModulo node) throws Exception {
		...
		C3aOperand op1 = node.getOp1().accept(this);
		C3aOperand op2 = node.getOp2().accept(this);
		C3aTemp resultDiv = c3a.newTemp();
		C3aTemp resultQuotient = c3a.newTemp();
		C3aTemp resultReste = c3a.newTemp();

		c3a.ajouteInst(new C3aInstDiv(op1, op2, resultDiv, ""));
		c3a.ajouteInst(new C3aInstMult(op2, resultDiv, resultQuotient,""));
		c3a.ajouteInst(new C3aInstSub(op1, resultQuotient, resultReste, ""));
